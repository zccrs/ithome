                                ...
                                if(post.status===200)
                                {
                                   ...
                                   if(post.responseText!=""){
                                        ...
                                        if(count>=50)//判断评论是否超过50,用来判断是否要显示“查看更多评论的选项”
                                            web.evaluateJavaScript("document.getElementById(\"commentlist\").innerHTML = unescape('<h3><span class=\"icon2\"></span>评论列表</h3><ul class=\"list\" id=\"LoadArticleReply\"></ul><ul class=\"list\" id=\"ulcommentlist\">"+string+"</ul><div class=\"more_comm\"><a id=\"pagecomment\" href=\"javascript:pagecomment(++commentpage,87);\">查看更多评论 ...</a></div>')");
                                        else
