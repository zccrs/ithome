...
PageStackWindow {
    ...
    {
        if(night_mode) utility.setCss("./qml/symbian-anna/comment_black.css",width-20)
        else utility.setCss("./qml/symbian-anna/comment_white.css",width-20)
    }
    function setCssToTheme()
    {
        if(night_mode) utility.setCss("./qml/symbian-anna/theme_black.css",width-20)
        else utility.setCss("./qml/symbian-anna/theme_white.css",width-20)
    }
